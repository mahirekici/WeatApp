...
final class DayDetailsViewController: BaseViewController, MKMapViewDelegate {
    ...
    init(presenter: DayDetailsPresenter) {
...
extension DayDetailsViewController: DayDetailsPresenterDelegate {
